 ...
 *
 * Sous 900px la barre cède la place à une barre supérieure, et revient en tiroir superposé.
  ...
  return (
    <div className="flex min-h-dvh">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        >
          <header className="sticky top-0 z-[150] flex items-center gap-3 border-b border-primary/12 bg-white px-4 py-3 min-[900px]:hidden">
            <Dialog.Trigger
          ...
          <Dialog.Portal>
            <Dialog.Overlay data-testid="sidebar-backdrop" className="fixed inset-0 z-[200] bg-slate-900/45" />
            <Dialog.Content
        ...
        <main id="contenu" className="flex-1 px-7 pt-7 pb-14 max-[640px]:px-3.5 max-[640px]:pt-5 max-[640px]:pb-10">
          <Outlet />
        </main>
      </div>
